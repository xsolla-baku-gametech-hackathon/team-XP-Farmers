...
Runtime components for Godot 4.7.2 (GDScript). No editor plugin, autoload, external
package or demo-game files are required.
...
- Privacy and chat are reserved integration folders; their runtime components are
  still being developed on separate team branches.
